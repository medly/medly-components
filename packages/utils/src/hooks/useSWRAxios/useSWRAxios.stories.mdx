...
**useAxios** returns all the fields from `SWRResponse` plus the below additional fields.
...
> Note: Add `dedupingInterval: 0` for testing purpose. To create a custom `render` method click [here](https://github.com/medly/medly-components/blob/master/packages/utils/src/test-utils.tsx).
