...
You can use this component to render `MarkdownContent`.
...
> **Note**: Mock the `@medly-components/markdown` if you're using jest for testing. We have difficulty developing tests because `react-markdown` is a pure ESM module and Jest ships with experimental support for ECMAScript Module. We're on the lookout for a suitable solution. You can read more about it [here](https://jestjs.io/docs/ecmascript-modules).
...
The markdown syntx guide contains various features to format your content.
