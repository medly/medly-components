        ...
        {() => {
            ...
            return (
                <TextField
                    ...
                    variant={select('Variant', variants, 'b2cField')}
...
<Preview withToolbar>
    ...
    <TextField id="rounded" type="Name" variant="rounded" label="Address" defaultValue="Demo" helperText="B2C" />
</Preview>
...
<Preview withToolbar>
    ...
    <TextField id="rounded" type="Name" variant="rounded" label="Address" defaultValue="Demo" errorText="Something wrong" />
</Preview>
