...
The Checkbox group component enables you to select a batch of options falling under a group. Each checkbox operates individually, so you can toggle each response “on” and off”.  
