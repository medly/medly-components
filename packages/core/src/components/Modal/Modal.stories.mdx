...
It consists of a Header, Content, and Footer. You can play with the component in the canvas tab.
...
The shadow effect apears on the Header & Footer section if you scroll through the content.
