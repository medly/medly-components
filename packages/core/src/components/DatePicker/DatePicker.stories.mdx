...
The `DatePicker` allows you to select a date through input text or using a calendar dialog. 
...
To use the calendar below, follow the steps given:
1. Select the calendar icon inside the DatePicker component to open the calendar.
2. Select any date or click outside the DatePicker component to close the calendar.
3. The provision to enter the date manually is applicable.
