...
export const groupedData = {
    ...
    rating: [
        ...
        },
        {
            rating: 4,
            count: 5,
            children: [data[1], data[2], data[4], data[5], data[6]]
        },
        {
            rating: 4.5,
            count: 1,
    ...
    isPassed: [
        {
            isPassed: true,
            count: 5,
            children: [data[0], data[1], data[2], data[3], data[4]]
        },
        {
            isPassed: false,
            count: 2,
