...
1. This component calls the validator prop function with the latest value on blur, and invalid and change events. Failing the validator function shows the default HTML5 error validation message if present.
