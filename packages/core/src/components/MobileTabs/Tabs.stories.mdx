...
<Preview withToolbar>
    <Story name="Mobile Tabs">
        <>
            <DarkBackground withGreyBackground={select('Tab Background', tabBg, 'WHITE')} />
            <Tabs defaultActive="tab1" aria-label="Basic Tabs">
                <Tabs.Tab id="tab1" label="Pay Now" elperText="Details" count={68}>
                    Content for the add panel
                </Tabs.Tab>
                <Tabs.Tab id="tab2" label="Pay at Delivery" helperText="Details" count={10}>
                    Content for the edit panel
                </Tabs.Tab>
                <Tabs.Tab id="tab3" label="Pay at Delivery" helperText="Details" count={30} disabled={true}>
                    Content for the delete panel
                </Tabs.Tab>
            </Tabs>
        </>
