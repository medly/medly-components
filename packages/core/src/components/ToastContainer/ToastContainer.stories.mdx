...
Whenever you want to rasie a toast, you can just call this function with variant and message. There are other params are also avialble to customize your toast.
