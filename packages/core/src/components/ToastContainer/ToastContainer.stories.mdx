...
Whenever you want to raise a toast, you can just call this function with the `variant` and `message` props. The other available parameters to customize your toast can be found under the Params title.
