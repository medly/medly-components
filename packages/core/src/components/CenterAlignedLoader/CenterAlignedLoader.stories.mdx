...
Center Aligned Loader displays a loading state while the main component mounts or the data loads. This component takes the width and height of the parent and then renders the loader in the center. 
