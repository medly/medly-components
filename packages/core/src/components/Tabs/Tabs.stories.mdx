    ...
    <Story name="WithoutIcon">
        <>
            ...
            <Tabs
                ...
                variant={select('Variant', ['flat', 'solid'], 'flat')}
            >
...
Use the `variant` prop to change the style of the tabs.

<Preview withToolbar>
    <Story name="FlatVariant">
        <Tabs
            defaultActive="tab1"
            aria-label="FlatVariant Tabs"
            variant='flat'
        >
            <Tabs.Tab id="tab1" label="Add" helperText="Details" count={0}>
                Content for the add panel
    ...
    <Story name="SolidVariant">
        <Tabs
            defaultActive="tab1"
            aria-label="SolidVariant Tabs"
            variant='solid'
        >
            <Tabs.Tab id="tab1" label="Add" helperText="Details" count={0}>
                Content for the add panel
