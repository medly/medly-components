...
Use the onChangeprop to make dateRangePicker a controlled component, and the `onPopupCloseprop` to handle actions (e.g. API calls) that you want to perform after date selection.
