...
const getStyle = ({ withWhiteBackground }: StyledProps) => {
    ...
    return css<StyledProps>`
        &::after {
            ...
            bottom: -1.6rem;
            left: 0;
            background-color: ${({ theme, isActive }) => (isActive ? theme.cardTable[bgTheme].headerActiveColor : 'transparent')};
            height: 0.2rem;
        ...
        ${HeadCellContent} {
            &:hover {
                ...
                ${Text.Style} {
                    color: ${({ theme }) => theme.cardTable[bgTheme].headerHoverColor};
                }
                ${SvgIcon} {
                    * {
                        fill: ${({ theme }) => theme.cardTable[bgTheme].headerHoverColor};
                    }
                }
            }
        }
