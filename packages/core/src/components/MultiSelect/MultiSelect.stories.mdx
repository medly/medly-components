...
You can pass a custom React component to be shown when no results are found in multi select search. For this you'll need to pass `hideOptionsOnNoResult` prop as true and pass your component to `noResultComponent` prop.
